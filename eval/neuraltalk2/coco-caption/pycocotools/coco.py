...
class COCO:
    def __init__(self, val_file = None):
        """
        ...
        self.imgs = []
        self.cats = []
        if not val_file == None:
            print 'loading annotations into memory...'
            time_t = datetime.datetime.utcnow()
            #train_data = json.load(open(train_file, 'r'))
            #val_data = json.load(open(val_file, 'r'))
            #train_data['images'] += val_data['images']
            #train_data['annotations'] += val_data['annotations']
            dataset = json.load(open(val_file, 'r'))
